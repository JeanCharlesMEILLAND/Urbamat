    ...
    blocks: [
      ...
      },
      {
        ...
        sections: [
          ...
          { key: "apropos_intro", label: "Introduction (HTML — autorise <p>, <strong>)", type: "html", placeholder: "<p>PME familiale basée en Alsace, URBAMAT Environnement conçoit et développe depuis le début des années 2000 des solutions en béton préfabriqué dédiées à la mobilité urbaine.</p><p>Sa philosophie s'inscrit dans une démarche d'amélioration de la qualité de service des transports publics afin de garantir une mobilité accessible, sûre et sans obstacle pour l'ensemble des usagers.</p>" },
    ...
    blocks: [
      ...
      },
      {
        ...
        sections: [
          ...
          { key: "contact_telephone_label", label: "Téléphone — Libellé", type: "texte", placeholder: "Téléphone" },
          { key: "contact_telephone", label: "Téléphone — Numéro", type: "texte", placeholder: "+33 (0)3 88 01 09 61" },
          { key: "contact_email_label", label: "Email — Libellé", type: "texte", placeholder: "Email" },
          { key: "contact_email", label: "Email — Adresse", type: "texte", placeholder: "contact@urbamat.fr" },
          { key: "contact_adresse_label", label: "Adresse — Libellé", type: "texte", placeholder: "Adresse" },
          { key: "contact_adresse", label: "Adresse — Valeur (multi-ligne, retour à la ligne autorisé)", type: "html", placeholder: "URBAMAT Environnement\n4 rue d'Altenheim\n67490 Lupstein, France" },
          { key: "contact_horaires_label", label: "Horaires — Libellé", type: "texte", placeholder: "Horaires" },
          { key: "contact_horaires", label: "Horaires — Valeur", type: "texte", placeholder: "Lun — Ven : 8h00 — 17h30" },
        ],
      },
      {
        id: "prescripteur",
    ...
    blocks: [
      {
        ...
        sections: [
          ...
          { key: "navbar_produit", label: "Lien 1 — Libellé Produit", type: "texte", placeholder: "Produit" },
          { key: "navbar_configurateur", label: "Lien 2 — Libellé Configurateur", type: "texte", placeholder: "Configurateur" },
          { key: "navbar_apropos", label: "Lien 3 — Libellé À propos", type: "texte", placeholder: "À propos" },
          { key: "navbar_telechargements", label: "Lien 4 — Libellé Téléchargements", type: "texte", placeholder: "Téléchargements" },
          { key: "navbar_contact", label: "Lien 5 — Libellé Contact", type: "texte", placeholder: "Contact" },
